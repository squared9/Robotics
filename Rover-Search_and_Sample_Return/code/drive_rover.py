...
class RoverState():
    def __init__(self):
        ...
        self.continuous_left = 0 # No of times in a row rover turns left
        self.continuous_right = 0 # No of times in a row rover turns right
        self.steps_to_follow = 0 # No of frames vehicle should continue in current mode
        self.continuous_slowness = 0 # No of frames with very slow/static movement
        self.recovery_direction = 1 # which way to turn during recovery
        self.sample_angle = None # attracting sample position
        self.sample_angular_distance = None # attracting sample position
